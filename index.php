...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <a href="dni.php"><img src="./img/Consulta DNI.png" class="d-block w-100" alt="..." height="500px"></a>
    </div>
    <div class="carousel-item" >
      <a href="ruc.php"><img src="./img/Consulta RUC.png" class="d-block w-100" alt="..." height="500px"></a>
    </div>
  </div>
